    ...
    <div className="flex justify-center my-12 items-center">
      ...
      <div className="w-full flex flex-col gap-y-8 lg:w-1/2">
        ...
        <div className="bg-gray-100 p-6 border-2 rounded-lg ">
          ...
          <div className="p-12 flex flex-col justify-center items-center">
            ...
            <label className=" cursor-pointer w-full" htmlFor="import">
              <div className=" h-[250px] flex justify-center items-center bg-white  rounded-lg border-dashed border-4"> <p><span className="text-blue-700">Click to update</span> or drag & drop the file</p></div>
        ...
        <div className="bg-gray-100 p-6 border-2 rounded-lg">
         ...
         <button className="bg-[#0369a1] text-white my-5 btn font-light">Export Database</button>
        </div>
