...
const SearchProducts = () => {
  ...
  return (
    ...
    <div className="mt-10">
      ...
      <form className="flex items-center max-w-sm mx-auto" onSubmit={SearchProductHandler}>
...
<div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow mx-auto">
    <a href="#">
        <img className="p-8 rounded-t-lg" src="https://images.unsplash.com/photo-1517329782449-810562a4ec2f?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8aW1hZ2V8ZW58MHx8MHx8fDA%3D" alt="product image" />
    </a>
